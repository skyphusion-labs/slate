...
> **You are here:** slate is the Discord front door. It sits at the top of the map (Discord chat -> slate -> the Studio). This page is the same in every constellation repo; the box named `slate` is this repo.
